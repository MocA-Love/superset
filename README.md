...
<details>
<summary><b>変更点一覧を開く</b> (80 件)</summary>
...
| **Service Status 管理ダッシュボード** | ヘッダーの Claude / Codex ステータス表示をハードコードから DB 駆動に刷新。Settings → Service Status から任意の Statuspage.io v2 互換プロバイダ (GitHub / Stripe / Cloudflare 等) を追加・編集・削除可能。アイコンは Simple Icons / favicon 自動取得 / 画像 URL / ローカルアップロードから選択。private network / loopback を弾く URL 検証と、userData 配下に境界ガード付きで画像を保存する custom protocol を備える | [#210](https://github.com/MocA-Love/superset/pull/210) [#407](https://github.com/MocA-Love/superset/pull/407) | 2026-04-24 |
...
| **autonomous TODO Agent 基盤** | TODO の自律実行・サブエージェント入れ子ライブストリーム UI・model/effort 指定・daemon 方式での永続化・PTY エンジン+Remote Control 統合などの TODO Agent コア機能群。後続のスケジュール (#211) や添付画像 (#229) はこれを前提にしている | [#181](https://github.com/MocA-Love/superset/pull/181) [#236](https://github.com/MocA-Love/superset/pull/236) [#245](https://github.com/MocA-Love/superset/pull/245) [#246](https://github.com/MocA-Love/superset/pull/246) [#278](https://github.com/MocA-Love/superset/pull/278) | 2026-04-15〜17 |
| **Warp ライクなウィンドウ透過 (vibrancy)** | macOS で `BrowserWindow.vibrancy` を使ってウィンドウ背景を半透明化。デフォルト OFF、Settings → Appearance から ON/OFF・透過レベルを調整可能。最小化→復元時に vibrancy が剥がれる問題、Settings プレビューと実機の不一致、codex / Claude Code TUI の背景が黒く残る問題も追って修正 | [#184](https://github.com/MocA-Love/superset/pull/184) [#208](https://github.com/MocA-Love/superset/pull/208) [#213](https://github.com/MocA-Love/superset/pull/213) [#425](https://github.com/MocA-Love/superset/pull/425) | 2026-04-15〜24 |
| **右クリックで CSS セレクター / XPath コピー** | ブラウザペインの右クリックメニューに「Copy CSS Selector」「Copy XPath」を追加。クリックした要素の安定したセレクターをワンクリックで取得 | [#281](https://github.com/MocA-Love/superset/pull/281) | 2026-04-17 |
| **カスタム通知音 (YouTube インポート対応)** | 通知音を YouTube URL から作成可能に (yt-dlp + ffmpeg を絶対パスで解決)。カスタム通知音の削除・リネーム、削除確認のカスタムダイアログ化、ボリュームをドロップダウンからスライダーに変更、YouTube インポート UX を全面改善 | [#259](https://github.com/MocA-Love/superset/pull/259) [#261](https://github.com/MocA-Love/superset/pull/261) [#265](https://github.com/MocA-Love/superset/pull/265) [#284](https://github.com/MocA-Love/superset/pull/284) [#285](https://github.com/MocA-Love/superset/pull/285) | 2026-04-17 |
| **Aivis API による音声読み上げ通知** | Aivis API による音声 TTS でタスク完了通知などを読み上げ。ユーザー辞書編集、日別使用量ダッシュボード、再生速度 (Speaking Rate) 設定、ボリューム/モデルプリセットタイル/モデル名表示、`{{branch}}` / `{{project}}` プレースホルダー対応 | [#287](https://github.com/MocA-Love/superset/pull/287) [#288](https://github.com/MocA-Love/superset/pull/288) [#292](https://github.com/MocA-Love/superset/pull/292) [#301](https://github.com/MocA-Love/superset/pull/301) [#338](https://github.com/MocA-Love/superset/pull/338) | 2026-04-17〜19 |
| **Files で音声 / 動画ファイルのプレビュー再生** | Files タブから .mp3 / .wav / .mp4 / .mov などの音声 / 動画ファイルをアプリ内でプレビュー再生 | [#317](https://github.com/MocA-Love/superset/pull/317) | 2026-04-18 |
| **外部 worktree の自動取り込み・自動反映** | アプリ外で `git worktree add` した worktree を自動検出してサイドバーに取り込み、`git worktree remove` で削除された worktree も自動で UI から除去 | [#326](https://github.com/MocA-Love/superset/pull/326) [#331](https://github.com/MocA-Love/superset/pull/331) | 2026-04-18 |
| **PR への新規コメント投稿** | Review タブから PR への新規コメント投稿が可能に。既存の Reply 機能 (#206) と組み合わせて PR 上の議論を Superset 内で完結できる | [#340](https://github.com/MocA-Love/superset/pull/340) | 2026-04-19 |
| **DnD / Open With でファイルを開く** | サイドバーからファイルをドラッグ&ドロップでペインに開けるようにし、v1 では split プレビューも表示。OS の "Open With" でも Superset を選択して任意のファイルを直接開ける | [#334](https://github.com/MocA-Love/superset/pull/334) [#336](https://github.com/MocA-Love/superset/pull/336) [#408](https://github.com/MocA-Love/superset/pull/408) [#412](https://github.com/MocA-Love/superset/pull/412) | 2026-04-19〜24 |
| **Browser pane Connect & CDP 統合** | ブラウザペインをエージェント session にバインドし、Chrome DevTools Protocol (CDP) 経由で browser-use 等の MCP から制御可能に。per-pane CDP endpoint + filter proxy + 固定グローバル CDP gateway + ペイン内複数タブを実装し、`mcp add` 一度で再起動・再アタッチ後も持続。独立パッケージ `superset-browser-mcp` として配布、Connect モーダルで workspace 優先の session 選択と権限プリセット UI を提供 | [#345](https://github.com/MocA-Love/superset/pull/345) [#354](https://github.com/MocA-Love/superset/pull/354) [#357](https://github.com/MocA-Love/superset/pull/357) [#358](https://github.com/MocA-Love/superset/pull/358) [#363](https://github.com/MocA-Love/superset/pull/363) [#367](https://github.com/MocA-Love/superset/pull/367) [#371](https://github.com/MocA-Love/superset/pull/371) [#379](https://github.com/MocA-Love/superset/pull/379) | 2026-04-20〜21 |
| **ターミナルタブの一括操作モード** | 複数のターミナルタブに対して同じコマンドを一斉送信できる一括操作モードを追加 | [#347](https://github.com/MocA-Love/superset/pull/347) | 2026-04-20 |
| **Cmd+P / Files / Search の VSCode 準拠化** | Quick Open (Cmd+P) と Files タブの検索ロジックを VSCode 準拠 (fuzzy + ranking) に刷新。Search タブも全文検索を VSCode 準拠に拡張、結果表示のコンパクト化、gitignore トグル、list / tree 切替の永続化を追加 | [#365](https://github.com/MocA-Love/superset/pull/365) [#369](https://github.com/MocA-Love/superset/pull/369) [#370](https://github.com/MocA-Love/superset/pull/370) [#410](https://github.com/MocA-Love/superset/pull/410) | 2026-04-20〜24 |
| **Kimi Code / OpenAI Codex CLI / Crush CLI 対応** | TODO Agent と Settings の Agent ピッカーに Kimi Code・OpenAI Codex CLI・Crush CLI のプリセットを追加。Kimi Code の VS Code 拡張も同梱対応 | [#373](https://github.com/MocA-Love/superset/pull/373) [#375](https://github.com/MocA-Love/superset/pull/375) [#385](https://github.com/MocA-Love/superset/pull/385) [#386](https://github.com/MocA-Love/superset/pull/386) | 2026-04-21〜23 |
| **Quick Open `:行番号` ジャンプ** | Cmd+P (Quick Open) で `path/to/file.ts:42` のように `:行番号` を続けると指定行に直接ジャンプ | [#384](https://github.com/MocA-Love/superset/pull/384) | 2026-04-22 |
| **Linux 永続化 + 自動ビルド** | Linux でアプリ終了後もターミナルと TODO Agent を維持。タグ push で AppImage / deb / rpm を CI で自動ビルドし、同名 Release に添付 | [#403](https://github.com/MocA-Love/superset/pull/403) [#421](https://github.com/MocA-Love/superset/pull/421) | 2026-04-24 |
