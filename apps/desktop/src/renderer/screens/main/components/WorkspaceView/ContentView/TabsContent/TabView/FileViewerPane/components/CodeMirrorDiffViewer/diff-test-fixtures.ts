...
const pureInsertion: DiffFixture = {
  ...
  description: "Lines added to b only. Should show green line bg only, no inline highlight.",
  language: "typescript",
  original: lines(
...
const pureDeletion: DiffFixture = {
  label: "pure-deletion",
  description: "Lines removed from a only. Should show red line bg only, no inline highlight. Empty space on b side.",
  language: "typescript",
  original: lines(
    "function greet(name: string) {",
    "  // Old comment 1",
...
const inlineChange: DiffFixture = {
  label: "inline-change",
  description: "Same line count, partial content changed. Should show inline highlight on changed characters.",
  language: "typescript",
  original: lines(
    "const MAX_RETRIES = 3;",
...
const mixedReplaceAndAdd: DiffFixture = {
  ...
  description: "Mix of replaced lines (show inline highlight) and pure additions (no inline highlight).",
  language: "typescript",
  original: lines(
...
const blockReplacement: DiffFixture = {
  ...
  description: "Multiple lines on both sides changed. Inline highlight on changed parts within lines.",
  language: "typescript",
  original: lines(
    "class UserService {",
    "  private db: Database;",
...
const fileAdded: DiffFixture = {
  label: "file-added",
  description: "Original is empty, all lines are added. No inline highlight anywhere.",
  language: "typescript",
  original: "",
  modified: lines(
    "import { z } from 'zod';",
...
const fileDeleted: DiffFixture = {
  label: "file-deleted",
  description: "Modified is empty, all lines are deleted. No inline highlight anywhere.",
  language: "typescript",
  original: lines(
...
const singleCharChange: DiffFixture = {
  ...
  description: "Only one character differs per line. Inline highlight should be tight.",
  language: "typescript",
  original: lines(
    "const x = 1;",
    "const y = 2;",
...
const realisticRefactor: DiffFixture = {
  ...
  description: "Realistic before/after of a small refactor with all patterns present.",
  language: "typescript",
  original: lines(
